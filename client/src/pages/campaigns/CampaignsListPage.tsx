      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-[var(--border-subtle)] flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => navigate('/campaigns/new')} className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] text-white text-sm font-semibold hover:opacity-90 transition-all shadow-[0_2px_8px_rgba(99,102,241,0.35)]">
...
function CampaignCard({ campaign, onOpen, onLaunch, onPause, onResume, onClone, onEdit, onDelete, onContextMenu }: any) {
  ...
  return (
    <div
      ...
      className={cn(
        'cursor-pointer rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-5 transition-all hover:border-[#6366F1]/30 hover:shadow-md group',
