/* The win/loss analysis on its own. See vite.harness.config.ts. */
import React from 'react';
import ReactDOM from 'react-dom/client';
import { MemoryRouter } from 'react-router-dom';
import { QueryClient, QueryClientProvider } from '@tanstack/react-query';
import { Toaster } from 'react-hot-toast';
import { DealInsightsPage } from '../src/pages/crm/DealInsightsPage';
        ...
        <div className="min-h-screen bg-[var(--bg-app)]">
          ...
          <div className="pl-[240px] pt-[56px]">
            <main className="mx-auto max-w-[1760px] px-8 py-7">
              <div className="route-fade"><DealInsightsPage /></div>
            </main>
          </div>
        </div>
