...
import { trackingDomainRoutes } from './tracking-domain.routes.js';
...
routes.use('/tracking-domain', trackingDomainRoutes);
routes.use('/readiness', readinessRoutes);
...
routes.use('/booking-links', bookingRoutes);
